...
export default function UserTop() {
    ...
    const SubmitReview = (e) => {
        ...
        if (!validator.isEmail(data.email)) {
            ...
            fetch(process.env.REACT_APP_BACKEND + '/api/update_user', {
                method: 'PUT',
                headers: {
                    'x-auth-token': token,
    ...
    const handlePhoto = (e) => {
        ...
        const token = sessionStorage.getItem('Token');
        // console.log(token);
        fetch(process.env.REACT_APP_BACKEND + '/api/update_image', {
            method: 'PATCH',
            headers: {
                'x-auth-token': token,
                'Accept': 'application/json',
                                ...
                                <div class="_row justify-content-center">
                                    <div class="col-lg-3 order-lg-2">
                                        {/* <div class="_card-profile-image">
                                            ...
                                            <img src={data.image && data.image.length !== 0 ? 'process.env.REACT_APP_BACKEND/images/' + data.image : Image} alt="" />
