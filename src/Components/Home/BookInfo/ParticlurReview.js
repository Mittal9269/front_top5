...
export default function ParticlurReview(props) {
    ...
    useEffect(() => {
        fetch(process.env.REACT_APP_BACKEND + '/reply/reply_comment/' + props.index, {
                method: 'GET',
                headers: {
    ...
    const SubmitReview = (e) => {
        ...
        setComment("");
        fetch(process.env.REACT_APP_BACKEND + '/reply/reply', {
                method: 'POST',
                headers: {
                    'Accept': 'application/json',
                    'Content-Type': 'application/json',
                    ...
                    <div class="col-md-12">
                        <div class="p-3 bg-white rounded mr-5 ml-lg-5">
                            <div class="review">
                                ...
                                <img class="rounded" src={props.value.UserId.image && props.value.UserId.image.length !== 0 ? process.env.REACT_APP_BACKEND + "/images/" + props.value.UserId.image : Image} width="50" alt="something new" />
                                    <div class="ml-2">
